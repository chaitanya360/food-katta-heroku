      ...
      <div>
        ...
        <div className="form-container">
          <div className="fields-wrapper">
            <div className="title">Create your selling account?</div>
            <div className="sub-title">
              Create an account to create global existance.
            </div>
            <div className="field-bundler">
              <div className="field">
                <span>
                  <img
            ...
            <div className="field-bundler">
              ...
              <div className="field">
                <span>
                  <img
                    src={`${process.env.PUBLIC_URL}/images/icons/shop.svg`}
                  />
                  <input
            ...
            <div className="field">
              <span>
                <img src={`${process.env.PUBLIC_URL}/images/icons/earth.svg`} />
                <input
            ...
            <h5 style={{ fontWeight: "300" }}>
              Seat back for some time, our team will varify your details.
            </h5>
          </div>
        </div>
